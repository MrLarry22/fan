/*
  # Fix Admin Content Access

  This migration fixes the RLS policies to allow admins to create content for any creator.
  The current policies only allow creators to manage their own content, but admins
  should be able to create content for any creator through the admin dashboard.
*/
